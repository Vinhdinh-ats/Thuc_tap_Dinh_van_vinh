...
class Program
{
    ...
    static void Main()
    {
        ThemSach(new Book(1, "Dế Mèn Phiêu Lưu Ký", "Tô Hoài", "Thiếu nhi", 5));
        ThemSach(new Book(2, "Lão Hạc", "Nam Cao", "Văn học", 2));
        ThemSach(new Book(3, "Toán 12", "Bộ GD", "Giáo khoa", 10));

        TimKiemSach("Nam Cao", true);
        PhanLoaiSach();
